...
- ✅ **Excel 가져오기**: 단어 목록을 Excel 파일에서 드래그앤드롭으로 가져올 수 있다.
- **통합 내보내기 기능**: 사용자는 하나의 내보내기 드롭다운 버튼을 통해 다양한 형태로 정보를 내보낼 수 있다.
  - **클립보드 복사**: 생성된 스토리를 클립보드로 복사할 수 있다.
  - **Excel 내보내기**: 현재 입력한 단어 목록과 관련 정보를 Excel 파일 형식으로 내보낼 수 있다.
  - **Markdown 내보내기**: 현재 생성한 스토리 출력 결과를 Markdown 형식의 파일로 내보낼 수 있다.
- **Markdown 템플릿 기능**: Markdown 내보내기 시 사용자 정의 템플릿을 활용하여 문서 형식을 유연하게 변경할 수 있다.
  - **기본 템플릿**: 시스템에서 제공하는 기본 Markdown 템플릿을 사용할 수 있다.
  - **템플릿 변수**: 제목, 날짜, 난이도, 단어 목록, 스토리 내용, 번역 등의 변수를 템플릿에서 활용할 수 있다.
  - **템플릿 커스터마이징**: 개발자가 템플릿 파일을 수정하여 출력 형식을 변경할 수 있다.
